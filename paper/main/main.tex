...
{\it Data:} Constituency-level data for national elections of 12 countries is obtained from CLEA \cite{clea}. Polling booth level data for India and Canada are obtained from the Election Commission of India \cite{india_data} and Elections Canada \cite{elections_canada}, respectively. Basic statistical features of these data sets and other processing details are given in SI \cite{supp}.  
...
\bibitem [{clea()}]{clea}%
  \BibitemOpen
  \href@noop {} {\bibinfo {title} {Constituency-Level Elections Archive (CLEA)}},\ \bibinfo {howpublished} {\url{http://www.electiondataarchive.org}}\BibitemShut {NoStop}%
\bibitem [{elections\_canada()}]{elections_canada}%
  \BibitemOpen
  \href@noop {} {\bibinfo {title} {Elections Canada}},\ \bibinfo {howpublished} {\url{https://www.elections.ca}}\BibitemShut {NoStop}%
