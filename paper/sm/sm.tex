...
\section{Connection to Order Statistics}
...
\begin{figure}[h]
    ...
    \caption{Comparison of analytical winner vote distribution with empirical data and simulations.}
    \label{fig:winner_sm}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Comparison of analytical runner-up vote distribution with empirical data and simulations.}
